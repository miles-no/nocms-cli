...
/***/ "./node_modules/nocms-server/lib/client/NoCMSClient.js":
/*!*************************************************************!*\
  !*** ./node_modules/nocms-server/lib/client/NoCMSClient.js ***!
  \*************************************************************/
/*! no static exports found */
...
var _nocmsEvents = __webpack_require__(/*! nocms-events */ "./node_modules/nocms-events/lib/index.js");

var _MainContent = _interopRequireDefault(__webpack_require__(/*! ../components/MainContent */ "./node_modules/nocms-server/lib/components/MainContent.js"));

__webpack_require__(/*! ./navigation */ "./node_modules/nocms-server/lib/client/navigation/index.js");
...
/*#__PURE__*/
function (_Component) {
  _inherits(NoCMSComponent, _Component);

  function NoCMSComponent(props) {
    var _this;

    _classCallCheck(this, NoCMSComponent);

    _this = _possibleConstructorReturn(this, (NoCMSComponent.__proto__ || Object.getPrototypeOf(NoCMSComponent)).call(this, props));
    _this.updatePageData = _this.updatePageData.bind(_assertThisInitialized(_this));
    var config = JSON.parse(document.getElementById('nocms.config').innerHTML);
    var i18n = JSON.parse(document.getElementById('nocms.i18n').innerHTML);
    var pageData = JSON.parse(document.getElementById('nocms.pageData').innerHTML);
    _this.state = {
      pageData: pageData,
      clientConfig: config,
      i18n: i18n
    };
    _this.state.isNoCMSUser = _this.isNoCMSUser();

    if (global.environment !== 'server') {
      global.NoCMS = {
        getPageData: function getPageData() {
          return _this.state.pageData;
        },
        getNoCMSUserInfo: function getNoCMSUserInfo() {
          return _this.getNoCMSUserInfo();
        },
        getConfig: function getConfig(field) {
          return _this.getConfig(field);
        }
      };
      (0, _nocmsEvents.listenToGlobal)('nocms.pagedata-updated', _this.updatePageData);
      (0, _nocmsEvents.listenToGlobal)('nocms.pagedata-loaded', _this.updatePageData);
    }

    return _this;
  }

  _createClass(NoCMSComponent, [{
    key: "getChildContext",
    ...
    value: function componentDidMount() {
      (0, _nocmsEvents.triggerGlobal)('nocms.client-loaded', this.state.pageData.uri, this.state.pageData);
    }
  }, {
    key: "getConfig",
    ...
    key: "getNoCMSUserInfo",
    value: function getNoCMSUserInfo() {
      var cookieName = this.getConfig('nocmsUserInfoCookieName');
      var regEx = new RegExp("".concat(cookieName, "=(.*?)(;|$)"));
      var adminInfo = document.cookie.match(regEx);
    ...
    key: "updatePageData",
    value: function updatePageData(newPageData) {
      this.setState({
    ...
    key: "isNoCMSUser",
    value: function isNoCMSUser() {
      return this.getNoCMSUserInfo() !== null;
    }
  }, {
    key: "render",
    value: function render() {
      return _react.default.createElement(_MainContent.default, {
  ...
  return NoCMSComponent;
}(_react.Component);

exports.default = NoCMSComponent;
...
//# sourceMappingURL=NoCMSClient.js.map
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../../webpack/buildin/global.js */ "./node_modules/webpack/buildin/global.js")))

/***/ }),

/***/ "./node_modules/nocms-server/lib/client/index.js":
/*!*******************************************************!*\
  !*** ./node_modules/nocms-server/lib/client/index.js ***!
  \*******************************************************/
/*! no static exports found */
...
var _NoCMSClient = _interopRequireDefault(__webpack_require__(/*! ./NoCMSClient */ "./node_modules/nocms-server/lib/client/NoCMSClient.js"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var templates = [];
var api = {
  setTemplates: function setTemplates(tmpl) {
    templates = tmpl;
    return this;
  },
  render: function render() {
    _reactDom.default.render(_react.default.createElement(_NoCMSClient.default, {
      templates: templates
...
/***/ "./node_modules/nocms-server/lib/client/navigation/index.js":
/*!******************************************************************!*\
  !*** ./node_modules/nocms-server/lib/client/navigation/index.js ***!
  \******************************************************************/
/*! no static exports found */
...
var _nocmsAjax = _interopRequireDefault(__webpack_require__(/*! nocms-ajax */ "./node_modules/nocms-ajax/lib/index.js"));

var _nocmsUtils = _interopRequireDefault(__webpack_require__(/*! nocms-utils */ "./node_modules/nocms-utils/lib/index.js"));

var _nocmsEvents = __webpack_require__(/*! nocms-events */ "./node_modules/nocms-events/lib/index.js");

__webpack_require__(/*! ./link_click_handler */ "./node_modules/nocms-server/lib/client/navigation/link_click_handler.js");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var handleScroll = function handleScroll() {
  _nocmsUtils.default.scrollTo(document.body, 0, 0);
};

var doNavigation = function doNavigation(pageData, url) {
  var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
  var _options$replaceState = options.replaceState,
      replaceState = _options$replaceState === void 0 ? false : _options$replaceState,
      _options$keepScrollPo = options.keepScrollPosition,
      keepScrollPosition = _options$keepScrollPo === void 0 ? false : _options$keepScrollPo;
  ...
  (0, _nocmsEvents.triggerGlobal)('nocms.pagedata-loaded', pageData);
  (0, _nocmsEvents.triggerGlobal)('nocms.close-modal');
  (0, _nocmsEvents.triggerGlobal)('track-event', 'navigation', window.location.pathname);
};

var handleResponse = function handleResponse(url, navigationOptions) {
  return function (err, response) {
    if (err) {
      ...
      (0, _nocmsEvents.triggerGlobal)('page_not_found', url);
      return;
    }
...
window.addEventListener('popstate', function (event) {
  (0, _nocmsEvents.triggerGlobal)('close-modal');

  if (event.state) {
    (0, _nocmsEvents.triggerGlobal)('nocms.pagedata-loaded', event.state);
  }
});
(0, _nocmsEvents.listenToGlobal)('nocms.client-loaded', function (uri, pageData) {
  history.replaceState(pageData, pageData.pageTitle, window.location.pathname + window.location.search);
});
(0, _nocmsEvents.listenToGlobal)('navigate', function (url, pageData, navigationOptions) {
  if (pageData) {
    doNavigation(pageData, url, navigationOptions);
    return;
  }

  _nocmsAjax.default.get(url, handleResponse(url, navigationOptions));
});
//# sourceMappingURL=index.js.map

/***/ }),

/***/ "./node_modules/nocms-server/lib/client/navigation/link_click_handler.js":
/*!*******************************************************************************!*\
  !*** ./node_modules/nocms-server/lib/client/navigation/link_click_handler.js ***!
  \*******************************************************************************/
/*! no static exports found */
...
var navigateNatively = [];

var findClosest = function findClosest(clickedEl, findFn) {
  var current = clickedEl;
...
var checkIfLinkShouldBeHandledNatively = function checkIfLinkShouldBeHandledNatively(clickedLink) {
...
(0, _nocmsEvents.listenToGlobal)('nocms.client-loaded', function () {
  ...
  document.body.addEventListener('click', function (e) {
    var clickedLink = findClosest(e.target, function (c) {
      return c.nodeName === 'A';
    });

    if (clickedLink) {
      if (findClosest(clickedLink, function (c) {
        return c.classList && c.classList.contains('edit-mode--active');
      })) {
        e.preventDefault();
        return;
      }
      ...
      if (href.indexOf('#') === 0) {
        ...
        (0, _nocmsEvents.triggerGlobal)('navigate_in_page', target);
        (0, _nocmsEvents.triggerGlobal)('track-event', 'navigation', 'in-page-navigation', window.location.pathname + href);
        return;
      }

      if (href.indexOf('://') === -1 && href.indexOf('mailto:') === -1 && href.indexOf('tel:') === -1) {
        e.preventDefault();
        (0, _nocmsEvents.triggerGlobal)('navigate', href); // triggerGlobal('track-event', 'navigation', window.location.pathname);
      }
    }
  });
});
//# sourceMappingURL=link_click_handler.js.map
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../../../webpack/buildin/global.js */ "./node_modules/webpack/buildin/global.js")))

/***/ }),

/***/ "./node_modules/nocms-server/lib/clientApp.js":
/*!****************************************************!*\
  !*** ./node_modules/nocms-server/lib/clientApp.js ***!
  \****************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "clientApp", {
  enumerable: true,
  get: function get() {
...
var _client = _interopRequireDefault(__webpack_require__(/*! ./client */ "./node_modules/nocms-server/lib/client/index.js"));
...
/***/ "./node_modules/nocms-server/lib/components/MainContent.js":
/*!*****************************************************************!*\
  !*** ./node_modules/nocms-server/lib/components/MainContent.js ***!
  \*****************************************************************/
/*! no static exports found */
...
var componentsWithDataScope = 'componentsWithData';
var componentsDataScope = 'componentData';

var getTemplateComponent = function getTemplateComponent(templateId, templates) {
  var template = templates.find(function (tmpl) {
    return tmpl.id === templateId;
  });

  if (!template) {
    throw new Error("Template \"".concat(templateId, "\" was not found"));
  }

  return template.component;
};

var createComponentDataApi = function createComponentDataApi(getPageData) {
  return {
    registerComponent: function registerComponent(componentType, componentId) {
      (0, _nocmsEvents.triggerGlobal)('nocms.value-changed', "".concat(componentsWithDataScope, ".").concat(componentType, ".").concat(componentId), {});
    },
    unregisterComponent: function unregisterComponent(componentType, componentId) {
      var pageData = getPageData();
      var _pageData$componentsW = pageData.componentsWithData,
          componentsWithData = _pageData$componentsW === void 0 ? {} : _pageData$componentsW;
      ...
      if (componentsWithData[componentType] && componentsWithData[componentType][componentId]) {
        ...
        (0, _nocmsEvents.triggerGlobal)('nocms.value-changed', componentsWithDataScope, componentsWithData);
      }
    },
    isComponentRegistered: function isComponentRegistered(componentType, componentId) {
      var pageData = getPageData();
      var _pageData$componentsW2 = pageData.componentsWithData,
          componentsWithData = _pageData$componentsW2 === void 0 ? {} : _pageData$componentsW2;
      return componentsWithData[componentType] && componentsWithData[componentType][componentId];
    },
    getComponentData: function getComponentData(componentType, componentId) {
      var pageData = getPageData();
      var _pageData$componentDa = pageData.componentData,
          componentData = _pageData$componentDa === void 0 ? {} : _pageData$componentDa;
    ...
    setComponentData: function setComponentData(componentType, componentId, componentData) {
      (0, _nocmsEvents.triggerGlobal)('nocms.value-changed', "".concat(componentsDataScope, ".").concat(componentType, ".").concat(componentId), componentData);
    }
  };
};
...
function (_Component) {
  ...
  function MainContent(props) {
    ...
    (0, _nocmsEvents.listenToGlobal)('nocms.toggle-edit', _this.toggleEdit);
    return _this;
  }
  ...
  _createClass(MainContent, [{
    ...
    value: function getChildContext() {
      ...
      return {
        ...
        adminLang: 'no',
        componentDataApi: createComponentDataApi(function () {
          return pageData;
        })
      };
    }
    ...
    value: function componentWillReceiveProps(props) {
      this.setState({
        lang: props.pageData.lang
      });
    }
  }, {
    key: "componentWillUnmount",
    value: function componentWillUnmount() {
      (0, _nocmsEvents.stopListenToGlobal)('nocms.toggle-edit', this.toggleEdit);
    }
  }, {
    key: "toggleEdit",
    ...
    value: function render() {
      ...
      return _react.default.createElement(getTemplateComponent(pageData.templateId, templates), pageData);
    }
  }]);
...
MainContent.childContextTypes = {
  ...
  adminLang: _propTypes.default.string,
  isNoCMSUser: _propTypes.default.bool,
  config: _propTypes.default.object,
  componentDataApi: _propTypes.default.object
};
...
var _clientApp = __webpack_require__(/*! nocms-server/lib/clientApp */ "./node_modules/nocms-server/lib/clientApp.js");

var _templates = _interopRequireDefault(__webpack_require__(/*! ./config/templates */ "./src/config/templates.js"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_clientApp.clientApp.setTemplates(_templates.default).render();
